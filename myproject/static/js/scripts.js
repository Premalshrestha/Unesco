...
document.querySelector('.welcome h2').textContent = `Welcome back, ${welcomeData.name}! 👋`;
document.querySelector('.welcome p').textContent = `You're ${welcomeData.weeks} weeks pregnant. Here's how you're doing today.`;
// End of dashboard